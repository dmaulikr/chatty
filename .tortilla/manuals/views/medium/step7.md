...
<b>+┊  ┊92┊    this.renderItem &#x3D; this.renderItem.bind(this);</b>
 ┊91┊93┊  }
 ┊92┊94┊
...
<b>+┊   ┊197┊  auth: PropTypes.shape({</b>
<b>+┊   ┊198┊    id: PropTypes.number,</b>
<b>+┊   ┊199┊    username: PropTypes.string,</b>
<b>+┊   ┊200┊  }),</b>
...
<b>+┊   ┊259┊  props: ({ ownProps, mutate }) &#x3D;&gt; ({</b>
<b>+┊   ┊260┊    createMessage: ({ text, groupId }) &#x3D;&gt;</b>
 ┊256┊261┊      mutate({
<b>+┊   ┊262┊        variables: { text, groupId },</b>
...
<b>+┊   ┊272┊              id: ownProps.auth.id,</b>
<b>+┊   ┊273┊              username: ownProps.auth.username,</b>
 ┊269┊274┊            },
 ┊270┊275┊            to: {
...
<i>╚══════╝</i>
 ...
 ┊308┊313┊});
 ┊309┊314┊
<b>+┊   ┊315┊const mapStateToProps &#x3D; ({ auth }) &#x3D;&gt; ({</b>
<b>+┊   ┊316┊  auth,</b>
<b>+┊   ┊317┊});</b>
<b>+┊   ┊318┊</b>
 ┊310┊319┊export default compose(
<b>+┊   ┊320┊  connect(mapStateToProps),</b>
 ┊311┊321┊  groupQuery,
...
<b>+┊  ┊18┊import { connect } from &#x27;react-redux&#x27;;</b>
 ┊18┊19┊
...
<b>+┊   ┊238┊  props: ({ ownProps, mutate }) &#x3D;&gt; ({</b>
<b>+┊   ┊239┊    createGroup: ({ name, userIds }) &#x3D;&gt;</b>
 ┊240┊240┊      mutate({
<b>+┊   ┊241┊        variables: { name, userIds },</b>
 ┊242┊242┊        update: (store, { data: { createGroup } }) &#x3D;&gt; {
 ┊243┊243┊          // Read the data from our cache for this query.
<b>+┊   ┊244┊          const data &#x3D; store.readQuery({ query: USER_QUERY, variables: { id: ownProps.auth.id } });</b>
 ┊245┊245┊
...
<b>+┊   ┊256┊            variables: { id: ownProps.auth.id },</b>
 ┊257┊257┊            data,
 ┊258┊258┊          });
 ┊259┊259┊        },
</pre>
...
<i>╚══════╝</i>
 ...
 ┊273┊273┊});
 ┊274┊274┊
<b>+┊   ┊275┊const mapStateToProps &#x3D; ({ auth }) &#x3D;&gt; ({</b>
<b>+┊   ┊276┊  auth,</b>
<b>+┊   ┊277┊});</b>
<b>+┊   ┊278┊</b>
 ┊275┊279┊export default compose(
<b>+┊   ┊280┊  connect(mapStateToProps),</b>
 ┊276┊281┊  userQuery,
...
<b>+┊   ┊234┊          const data &#x3D; store.readQuery({ query: USER_QUERY, variables: { id: ownProps.auth.id } });</b>
 ┊235┊235┊
...
<b>+┊   ┊242┊            variables: { id: ownProps.auth.id },</b>
 ┊243┊243┊            data,
 ┊244┊244┊          });
 ┊245┊245┊        },
</pre>
...
<b>+┊   ┊252┊    leaveGroup: ({ id }) &#x3D;&gt;</b>
 ┊253┊253┊      mutate({
<b>+┊   ┊254┊        variables: { id },</b>
 ┊255┊255┊        update: (store, { data: { leaveGroup } }) &#x3D;&gt; {
 ┊256┊256┊          // Read the data from our cache for this query.
<b>+┊   ┊257┊          const data &#x3D; store.readQuery({ query: USER_QUERY, variables: { id: ownProps.auth.id } });</b>
 ┊258┊258┊
...
<b>+┊   ┊265┊            variables: { id: ownProps.auth.id },</b>
 ┊266┊266┊            data,
 ┊267┊267┊          });
 ┊268┊268┊        },
</pre>
...
<i>╚══════╝</i>
 ...
 ┊271┊271┊});
 ┊272┊272┊
<b>+┊   ┊273┊const mapStateToProps &#x3D; ({ auth }) &#x3D;&gt; ({</b>
<b>+┊   ┊274┊  auth,</b>
<b>+┊   ┊275┊});</b>
<b>+┊   ┊276┊</b>
 ┊273┊277┊export default compose(
<b>+┊   ┊278┊  connect(mapStateToProps),</b>
 ┊274┊279┊  groupQuery,
...
<b>+┊   ┊318┊  options: ownProps &#x3D;&gt; ({ variables: { id: ownProps.auth.id } }),</b>
 ┊318┊319┊  props: ({ data: { loading, user } }) &#x3D;&gt; ({
 ┊319┊320┊    loading, user,
 ┊320┊321┊  }),
 ┊321┊322┊});
 ┊322┊323┊
<b>+┊   ┊324┊const mapStateToProps &#x3D; ({ auth }) &#x3D;&gt; ({</b>
<b>+┊   ┊325┊  auth,</b>
<b>+┊   ┊326┊});</b>
<b>+┊   ┊327┊</b>
 ┊323┊328┊export default compose(
<b>+┊   ┊329┊  connect(mapStateToProps),</b>
 ┊324┊330┊  userQuery,
 ┊325┊331┊)(NewGroup);
</pre>
