...
<b>        (payload, args) &#x3D;&gt; {</b>
<b>          return Boolean(args.groupIds &amp;&amp; ~args.groupIds.indexOf(payload.messageAdded.groupId));</b>
<b>        },</b>
<b>      ),</b>
    },
  },
...
<b>        (payload, args) &#x3D;&gt; {</b>
<b>          return Boolean(args.userId &amp;&amp; ~map(payload.groupAdded.users, &#x27;id&#x27;).indexOf(args.userId));</b>
<b>        },</b>
<b>      ),</b>
    },
  },
...
<b>            // if it&#x27;s our own mutation</b>
<b>            // we might get the subscription result</b>
<b>            // after the mutation result.</b>
<b>            if (isDuplicateMessage(</b>
<b>              newMessage, previousResult.group.messages)</b>
<b>            ) {</b>
<b>              return previousResult;</b>
<b>            }</b>
...
<b>  props: ({ data: { fetchMore, loading, group, networkStatus, subscribeToMore } }) &#x3D;&gt; ({</b>
    loading,
    group,
    networkStatus,
<b>    subscribeToMore,</b>
...
<b></b>
<b>// helper function checks for duplicate documents</b>
<b>// TODO: it&#x27;s pretty inefficient to scan all the documents every time.</b>
<b>// maybe only scan the first 10, or up to a certain timestamp</b>
<b>function isDuplicateDocument(newDocument, existingDocuments) {</b>
<b>  return newDocument.id !&#x3D;&#x3D; null &amp;&amp; existingDocuments.some(doc &#x3D;&gt; newDocument.id &#x3D;&#x3D;&#x3D; doc.id);</b>
<b>}</b>
<b></b>
const styles &#x3D; StyleSheet.create({
  container: {
...
<b>          // we might get the subscription result</b>
<b>          // after the mutation result.</b>
<b>          if (isDuplicateDocument(newMessage, previousGroups[groupIndex].messages)) {</b>
<b>            return previousResult;</b>
<b>          }</b>
<b></b>
<b>          return update(previousResult, {</b>
...
<b>          // we might get the subscription result</b>
<b>          // after the mutation result.</b>
<b>          if (isDuplicateDocument(newGroup, previousGroups)) {</b>
<b>            return previousResult;</b>
<b>          }</b>
<b></b>
<b>          return update(previousResult, {</b>
